...
export function NewChatDialog() {
  ...
  function reset() {
    setMode("choose"); setQuery(""); setResults([]); setSelected([]); setName("");
  ...
  return <>
    <button type="button" onClick={() => setOpen(true)} aria-label="Start a new chat" className="btn btn-primary h-9 w-9 rounded-xl! p-0!"><SquarePen className="h-4 w-4" /></button>
