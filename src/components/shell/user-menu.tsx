...
import { ChevronDown, ChevronRight, LogOut, Settings, Star, UserRound } from "lucide-react";
      ...
      {open ? (
        ...
        >
          ...
          <Link
            ...
            className="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm text-[var(--muted)] transition-colors hover:bg-[color-mix(in_srgb,var(--muted)_10%,transparent)] hover:text-[var(--text)]"
          >
            <Settings className="h-4 w-4" /> Settings <ChevronRight className="ml-auto h-4 w-4" />
          </Link>
          <Link
            href="/app/starred"
            role="menuitem"
