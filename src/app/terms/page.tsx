...
export const metadata: Metadata = {
  title: "Terms of Service — Circlo",
  description: "Circlo terms of service and community guidelines.",
};
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="prose-card mt-8 space-y-8 text-sm leading-relaxed text-[var(--muted)]">
          <section>
            ...
            <p className="mt-2">
              By accessing or using Circlo, you agree to be bound by these Terms of Service.
          ...
          <section>
            ...
            <p className="mt-2">
              Circlo is a real-time messaging application that allows users to communicate
          ...
          <section>
            ...
            <p className="mt-2">
              You retain ownership of the content you create and share on Circlo. By sending
              messages, you grant Circlo a limited license to process and deliver your content
          ...
          <section>
            ...
            <p className="mt-2">
              Your use of Circlo is also governed by our{" "}
          ...
          <section>
            ...
            <p className="mt-2">
              Circlo is provided &ldquo;as is&rdquo; without warranties of any kind. We are
