...
import { getMembership, listConversationMedia } from "@/server/chat";

export const dynamic = "force-dynamic";

/** List image/video attachments for a conversation. Members only. */
export async function GET(
  ...
  const media = await listConversationMedia(id, me.id);
