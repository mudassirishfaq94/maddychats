...
export const metadata: Metadata = {
  title: "Privacy Policy — Circlo",
  description: "Circlo privacy policy. Learn how we collect, use, and protect your data.",
};
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="prose-card mt-8 space-y-8 text-sm leading-relaxed text-[var(--muted)]">
          <section>
            ...
            <p className="mt-2">
              When you use Circlo, we collect information you provide directly and information
          ...
          <section>
            ...
            <ul className="mt-2 list-disc pl-5 space-y-1">
              <li>To provide, maintain, and improve the Circlo service</li>
          ...
          <section>
            ...
            <p className="mt-2">
              Circlo provides built-in privacy settings that you control:
            </p>
            <ul className="mt-2 list-disc pl-5 space-y-1">
          ...
          <section>
            ...
            <p className="mt-2">
              Circlo is not intended for users under the age of 13. We do not knowingly collect
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              us through the Circlo application.
            </p>
          </section>
        </div>
      </div>
